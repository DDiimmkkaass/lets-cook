    ...
    public function createInviteFriendCoupon(User $user)
    {
        return $this->create(
            [
                ...
                'discount_type' => Coupon::getDiscountTypeIdByName(variable('invite_friend_discount_type')),
                'count'         => 1,
                'users_count'   => 0,
                'users_type'    => Coupon::getUsersTypeIdByName('new'),
                'started_at'    => Carbon::now()->format('d-m-Y'),
    ...
    public function giveInviteFriendCompensationCoupon(User $for_user, User $from_user, $default = false)
    {
        $coupon = $this->create(
            [
                ...
                'discount_type' => Coupon::getDiscountTypeIdByName(variable('invite_friend_compensation_type')),
                'count'         => 1,
                'users_count'   => 1,
