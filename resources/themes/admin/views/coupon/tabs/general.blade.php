...
<div class="form-group required @if ($errors->has('count')) has-error @endif">
    {!! Form::label('count', trans('labels.count'), ['class' => 'control-label col-xs-12 col-sm-3 col-md-2']) !!}

    <div class="col-xs-12 col-sm-2 col-md-2">
        {!! Form::text('count', $model->count ?: 0, ['class' => 'form-control input-sm', 'aria-hidden' => 'true', 'required' => true]) !!}
...
<div class="form-group required @if ($errors->has('users_count')) has-error @endif">
    ...
    <div class="col-xs-12 col-sm-2 col-md-2">
        {!! Form::text('users_count', $model->users_count ?: 0, ['class' => 'form-control input-sm', 'aria-hidden' => 'true', 'required' => true]) !!}
