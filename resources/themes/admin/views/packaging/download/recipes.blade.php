...
<div class="box-body table-responsive no-padding">
    <table class="table table-bordered recipes-packaging">
        ...
        <tr>
            ...
            <th style="text-align: center;">@lang('labels.total')</th>
        </tr>
            ...
            @if (count($ingredients))
                ...
                @foreach($ingredients as $ingredient)
                    <tr>
                        ...
                        <td style="text-align: center;">{!! $ingredient['total'] !!}</td>
                    </tr>
                @endforeach
                <tr><td colspan="5" style="height: 1px; border-bottom: 1px solid #000"></td></tr>
                <tr><td colspan="5"></td></tr>
            @endif
        @endforeach
        ...
        @unless (empty($recipe['ingredients']))
            ...
            @foreach($recipe['ingredients'] as $key => $ingredients)
                <tr>
                    <td style="height: {!! 17 * count($ingredients) !!}px; vertical-align: top;" colspan="5">
                        @foreach($ingredients as $ingredient)
                            - {!! $ingredient->name !!}
