<div class="form-group">
    ...
    <div class="col-xs-12 col-sm-6 col-md-5 col-lg-4">
        {!! Form::select((isset($array_name) ? $array_name : 'tags').'[]', isset($tags_array) ? $tags_array : (isset($tags) ? $tags : []), isset($selected_tags) ? $selected_tags : [], ['class' => 'select2', 'multiple' => 'multiple']) !!}
